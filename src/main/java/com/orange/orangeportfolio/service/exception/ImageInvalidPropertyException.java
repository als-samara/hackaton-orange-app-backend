...
public class ImageInvalidPropertyException extends HttpClientErrorException{

	private static final long serialVersionUID = 1L;
	private static final String defaultMessage = "Image property is null or empty, PropertyName=%s";

	public ImageInvalidPropertyException(String propertyName) {
